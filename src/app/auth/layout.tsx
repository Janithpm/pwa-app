                ...
                <div className="bg-primary relative order-2 hidden h-full rounded-3xl lg:flex">
                    ...
                    <div className="absolute bottom-10 flex w-full justify-between px-10">
                        <div className="text-primary-foreground flex-1 space-y-1">
                            ...
                            <p className="text-sm">Track vehicle availability, maintenance schedules. Keep every car on the road and every booking running smoothly.</p>
                        </div>
                        <Separator orientation="vertical" className="mx-3 h-auto!" />
                        <div className="text-primary-foreground flex-1 space-y-1">
                            <h2 className="font-medium">Need assistance?</h2>
                            <p className="text-sm">
                                Browse our documentation or reach out to support anytime. We&apos;re here to help your rental service scale.
                            </p>
                        </div>
                    </div>
                </div>
